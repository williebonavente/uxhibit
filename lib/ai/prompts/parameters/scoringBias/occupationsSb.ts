export const occupationsSb = `{
  ...
  "Freelancer": {
    "justification": "Freelancers often multitask and require quick task execution with low cognitive load. Studies on productivity UX (Oulasvirta & Hornbæk, 2016) show they value efficient interaction and low-friction UI. Thus, weights increase for efficiency of use (Heuristic 07) and flexibility (Heuristic 09)."
  },
  "Designer": {
