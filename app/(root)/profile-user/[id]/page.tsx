...
export default async function ProfilePage(propsPromise: Promise<ProfilePages>) {
  ...
  const skills =
    (skillsData as ProfileSkillRow[] | null)
  ...
  const featuredWorks = [
    {
      ...
      description:
        "Redesigned for better accessibility and intuitive navigation.",
      link: "https://yourwebsite.com/mobile-banking-case-study",
    },
    {
      title: "E-Commerce Website",
      image:
        "https://kinsta.com/wp-content/uploads/2019/01/portfolio-website-thumbnail-gallery.jpeg",
      description:
        "Boosted conversion rates with streamlined checkout and product filtering.",
      link: "https://yourwebsite.com/ecommerce-case-study",
    },
    {
      title: "Fitness Tracker Dashboard",
      image:
        "https://s3-alpha.figma.com/hub/file/1712964412/01a3dfa4-6614-4801-9617-932b46d23c6b-cover.png",
      description:
        "Designed a responsive dashboard for tracking workouts and goals.",
      link: "https://yourwebsite.com/fitness-tracker-case-study",
    },
    {
      title: "Online Learning Platform",
      image:
        "https://uihut-data.fra1.cdn.digitaloceanspaces.com/design/web-app/pack/thumbnail/UH27pM1N8dTXtxVq.webp",
      description:
        "Enhanced course discovery and accessibility for diverse learners.",
  ...
  const caseStudies = [
    {
      ...
      image:
        "https://s3-alpha.figma.com/hub/file/5171202716/bc6c04cc-1149-4577-8c6d-bde4eddc3259-cover.png",
      summary:
        "Designed for WCAG 2.1 AA compliance, improving usability for low-vision users.",
    ...
    },
    {
      ...
      image:
        "https://elements-resized.envatousercontent.com/elements-cover-images/bbd576b4-5842-49f1-995a-c52037bff2fc?w=433&cf_fit=scale-down&q=85&format=auto&s=ecae5006537ed362c9a196379797d9729eca2a8dfc7456461287b2e771e33eca",
      summary:
        "Applied POUR principles to restructure content hierarchy and navigation.",
    ...
    },
    {
      ...
      image:
        "https://mir-s3-cdn-cf.behance.net/projects/404/90bcea159012677.Y3JvcCwxNTM0LDEyMDAsMzQsMA.png",
      summary:
        "Designed for hands-free interaction and screen reader compatibility.",
    ...
    },
    {
      ...
      image:
        "https://ictsolved.github.io/assets/images/blog/2019-11-30-bookstore-app-ui-designs-for-inspiration/bookstore-app-ui-cover.png",
      summary:
        "Implemented semantic HTML and ARIA roles for screen reader support.",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {featuredWorks.map((work, i) => (
                <Link
                  ...
                  href={work.link}
                  target="_blank"
                  className="group bg-white dark:bg-[#1A1A1A] shadow-md rounded-xl p-3 gap-2 hover:scale-[1.05] transition-transform duration-200 cursor-pointer"
                >
                  <Image
                    src={work.image}
                    alt={work.title}
                  ...
                  />
                  <h3 className="font-semibold break-words leading-5 text-[#ED5E20] dark:text-white mb-3">
                    {work.title}
                  </h3>
              ...
              {caseStudies.map((study, i) => (
                ...
                >
                  <Image
                    ...
                    width={400}
                    height={200}
                    className="rounded-md mb-3 object-cover w-full h-40 border"
                  />
                  <h3 className="font-semibold break-words leading-5 text-[#ED5E20] dark:text-white mb-3">
                    {study.title}
                  </h3>
                  ...
                  <p className="text-xs text-gray-400 italic flex items-center gap-1">
                    <ArrowUpRight size={12} /> {study.outcome}
                  </p>
                </Link>
              ))}
            </div>
        ...
        <div className="flex-1 bg-white dark:bg-[#1A1A1A]/25 rounded-xl p-5 shadow-md">
          ...
          <div className="space-y-4">
            <blockquote className="text-sm text-gray-500 dark:text-gray-300 italic border-l-4 border-green-400 pl-4">
              “Vanness has a rare ability to blend accessibility with stunning
              design. A true collaborator.”
              <footer className="mt-2 text-xs text-gray-400">
                — Jane Smith, Product Manager
              </footer>
            </blockquote>
            <blockquote className="text-sm text-gray-500 dark:text-gray-300 italic border-l-4 border-green-400 pl-4">
              “His attention to detail and POUR principles made our app usable
              for everyone.”
              <footer className="mt-2 text-xs text-gray-400">
                — Alex Tan, Frontend Engineer
              </footer>
            </blockquote>
          </div>
        </div>
