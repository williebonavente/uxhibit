        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center space-x-2 mb-2">
              <span className="bg-[#ED5E20] text-white px-3 py-1 rounded text-sm font-medium">
                📊 Evaluate Design
              </span>
            </div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2 max-w-4xl font-['Poppins']">
          ...
          <button className="bg-[#ED5E20] hover:bg-[#d44e0f] text-white px-6 py-3 rounded-lg flex items-center space-x-2 transition-colors font-['Poppins'] font-medium">
            <span>📊</span>
