...
export default function EvaluateWizard() {
    ...
    return (
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-4 py-8">
            ...
            <div className="w-full max-w-3xl relative overflow-hidden rounded-2xl shadow-xl">
                ...
                <div className="relative z-10 p-6 md:p-10 flex flex-col gap-8" style={cardCursor}>
                  ...
                  ${step === n ? "bg-[#ED5E20] text-white" : "bg-white/70 dark:bg-black/40 text-neutral-600 dark:text-neutral-300"}`}
                                >
                                    {n}
                                </span>
                                <span className={`hidden sm:inline ${step === n ? "text-neutral-900 dark:text-neutral-100" : "text-neutral-500 dark:text-neutral-400"}`}>
                                    {n === 1 && "Parameters"}
                                    {n === 2 && "Upload"}
                                    {n === 3 && "Review"}
                                </span>
                                {n < 3 && <div className="h-px w-10 bg-gradient-to-r from-transparent via-neutral-300/60 dark:via-neutral-600/50 to-transparent" />}
                            </div>
                        ))}
                    </div>
    ...
    ${canNextFrom1 ? "cursor-pointer text-white" : "cursor-not-allowed text-neutral-300 dark:text-neutral-500"}
    ${canNextFrom1
  ...
  `}
                    ...
                    {step === 2 && (
                        <div className="space-y-6">
                            <p className="text-center text-sm md:text-base">Paste your Figma link and preview.</p>
                            <input
                                type="url"
                                value={link}
                      ...
                      ${canParse ? "bg-[#ED5E20] hover:bg-orange-600" : "bg-gray-400 cursor-not-allowed"}`}>
                                    ...
                                    <button
                                        ...
                                        className={`px-6 py-2 rounded-lg text-sm font-semibold text-white
                      ${parsed ? "bg-[#ED5E20] hover:bg-orange-600" : "bg-gray-400 cursor-not-allowed"}`}>
                                        Review
                                    </button>
                                </div>
                            </div>
                    ...
                    {step === 3 && parsed && (
                        <div className="space-y-6">
                            <p className="text-center text-sm md:text-base">Review and submit.</p>
                            <div className="grid gap-4">
                                <div className="rounded-lg p-4 border bg-white/70 dark:bg-neutral-800/60">
                                    ...
                                    <p className="text-xs md:text-sm">Generation: <span className="font-medium">{age}</span></p>
                                    <p className="text-xs md:text-sm">Occupation: <span className="font-medium">{occupation}</span></p>
                                </div>
                                <div className="rounded-lg p-4 border bg-white/70 dark:bg-neutral-800/60">
                                    ...
                                    <p className="text-xs md:text-sm font-medium">{parsed.name}</p>
                                    <p className="text-[11px] opacity-70 break-all">File Key: {parsed.fileKey}</p>
                                    {parsed.nodeId && <p className="text-[11px] opacity-70 break-all">Node: {parsed.nodeId}</p>}
                                </div>
                            </div>
                            <div className="flex justify-between gap-4">
                                <button
                      ...
                      ${submitting ? "bg-gray-400 cursor-not-allowed" : "bg-[#ED5E20] hover:bg-orange-600"}`}>
