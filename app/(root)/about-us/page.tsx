...
export default function AboutUs() {
  return (
    <div className="min-h-screen px-6 sm:px-12 py-16 bg-white dark:bg-[#0a0a0a] text-gray-800 dark:text-gray-200 transition-colors duration-300">
      <div className="max-w-6xl mx-auto space-y-16">
        {/* Hero Section */}
        <section className="text-center space-y-4">
          <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white">
            About <span className="text-orange-500">UXhibit</span>
          </h1>
          <p className="max-w-3xl mx-auto text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            ...
            <span className="text-orange-500 font-semibold">AI-driven insights</span>,{" "}
            <span className="text-orange-500 font-semibold">guided learning</span>, and{" "}
            <span className="text-orange-500 font-semibold">hands-on evaluation</span> — bridging
        ...
        <section className="space-y-10">
          ...
          <div className="flex flex-col items-center justify-center text-center leading-relaxed space-y-6">
            <a
            ...
            <p className="max-w-3xl text-lg text-gray-700 dark:text-gray-200">
              <span className="text-orange-500 font-semibold">UXhibit</span> is a web-based design
              evaluation tool that empowers aspiring UI/UX designers to improve their craft through{" "}
              <span className="text-orange-500 font-semibold">AI-driven feedback</span> and{" "}
              <span className="text-orange-500 font-semibold">guided learning</span>. Designed as an
          ...
          <div className="grid md:grid-cols-2 gap-10 leading-relaxed">
            ...
            <div className="text-gray-700 dark:text-gray-300">
              <p>
                ...
                <span className="text-orange-500 font-semibold">self-directed growth</span>,
        ...
        <section className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="bg-gray-100 dark:bg-[#141414] p-8 rounded-2xl border border-gray-300 dark:border-gray-800 hover:border-orange-500 transition-colors duration-300">
        ...
        <section className="text-center mt-16">
          <h2 className="text-4xl font-bold text-orange-500 mb-12">Meet the Team</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center bg-gray-100 dark:bg-[#141414] rounded-2xl p-6 hover:scale-105 hover:border-orange-500 border border-gray-300 dark:border-gray-800 transition-transform duration-300"
              >
                <Image
                  src={member.img}
                  alt={member.name}
                  width={120}
                  height={120}
                  className="rounded-full border-2 border-orange-500 object-cover mb-4"
                />
