...
const ProfileCareerHighForm: React.FC<ProfileCareerHighFormProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative z-10 flex flex-col w-full max-w-sm sm:max-w-md md:max-w-xl p-6 sm:p-8 md:p-10 bg-white dark:bg-[#1A1A1A] rounded-2xl shadow-xl border border-white/20 cursor-default"
                ...
                <tr>
                  <td className="py-2">
                    <button
                      type="button"
                      onClick={handleAdd}
                      className="w-full mb-5 py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 text-[#ED5E20] border border-dashed border-[#ED5E20]/50 hover:bg-[#ED5E20]/10 transition cursor-pointer"
