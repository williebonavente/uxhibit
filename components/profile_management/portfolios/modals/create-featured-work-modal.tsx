...
type Props = {
    open: boolean;
    onClose: () => void;
    onCreated?: (work: FeaturedWork) => void;
    userId: string;
    initialData?: FeaturedWork;
    isEdit?: boolean;
}

export default function CreateFeaturedWorkModal({
    open,
    onClose,
    onCreated,
    userId,
            ...
            >
                ...
                {(!isEdit && mode === null) && (
                    <div className="flex flex-col gap-4 mb-6">
                        <h4 className="text-lg font-semibold text-center">How would you like to add your portfolio item?</h4>
